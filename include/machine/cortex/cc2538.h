...
class CC2538: public IEEE802_15_4::NIC_Base<IEEE802_15_4, Traits<NIC>::NICS::Polymorphic>, public IF<EQUAL<Traits<Network>::NETWORKS::Get<Traits<NIC>::NICS::Find<CC2538>::Result>::Result, _SYS::TSTP>::Result, IF<Traits<System>::DUTY_CYCLE == 1000000, TSTP_MAC_NOMF<CC2538RF>, TSTP_MAC<CC2538RF>>::Result, IEEE802_15_4_MAC<CC2538RF>>::Result
{
    template <typename Type, int unit> friend void call_init();

private:
    typedef IF<EQUAL<Traits<Network>::NETWORKS::Get<Traits<NIC>::NICS::Find<CC2538>::Result>::Result, _SYS::TSTP>::Result, IF<Traits<System>::DUTY_CYCLE == 1000000, TSTP_MAC_NOMF<CC2538RF>, TSTP_MAC<CC2538RF>>::Result, IEEE802_15_4_MAC<CC2538RF>>::Result MAC;
