...
public:
    ...
    void get_sector_address(int index, unsigned int *data_block_address, unsigned int *data_block_size) {
        *data_block_address = SIZE_OF_PAGE*index;
        *data_block_size = SIZE_OF_PAGE;
    }
